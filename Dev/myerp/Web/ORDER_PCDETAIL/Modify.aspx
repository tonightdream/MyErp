<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="MyERP.Web.ORDER_PCDETAIL.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_LOGO" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_DESCRIPTION
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_DESCRIPTION" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_CD
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_SPECIFICATIONS" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_MEASURE_UNIT
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_MEASURE_UNIT" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_GYLC
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_POSITION" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_MIN_QTY
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_MIN_QTY" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_MAX_QTY
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_MAX_QTY" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_IMAGE
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_IMAGE" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_IMAGE_NAME
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_IMAGE_NAME" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_DWMJ
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_DWMJ" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ITEM_BARCODE
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtITEM_BARCODE" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		NET_PRICE
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtORD_GRAPHICNO" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		ORD_SHDH
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtORD_BZFS" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		REMARK
