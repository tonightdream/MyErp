<%@ Page Title="SAL_RECEIPT_MASTER" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.SAL_RECEIPT_MASTER.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="INSTOCK_CODE" HeaderText="INSTOCK_CODE" SortExpression="INSTOCK_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="INSTOCK_NAME" HeaderText="INSTOCK_NAME" SortExpression="INSTOCK_NAME" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="PayAcount" HeaderText="PayAcount" SortExpression="PayAcount" ItemStyle-HorizontalAlign="Center"  /> 
