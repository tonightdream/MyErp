<%@ Page Title="STEEL_DA" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.STEEL_DA.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="ITEM_CODE" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="ITEM_HD" HeaderText="ITEM_HD" SortExpression="ITEM_HD" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="TYPE_NAME" HeaderText="TYPE_NAME" SortExpression="TYPE_NAME" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="MEASURE_CODE" HeaderText="MEASURE_CODE" SortExpression="MEASURE_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="POSITION_CODE" HeaderText="POSITION_CODE" SortExpression="POSITION_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="REMARK" HeaderText="REMARK" SortExpression="REMARK" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="ITEM_CODE" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="ITEM_CODE" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  />
