<%@ Page Title="STEEL_GG" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.STEEL_GG.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="INTERNAL_CODE" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="HD" HeaderText="HD" SortExpression="HD" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="KD" HeaderText="KD" SortExpression="KD" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="REMARK" HeaderText="REMARK" SortExpression="REMARK" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="INTERNAL_CODE" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="INTERNAL_CODE" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  />
