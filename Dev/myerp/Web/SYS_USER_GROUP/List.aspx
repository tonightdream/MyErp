<%@ Page Title="SYS_USER_GROUP" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.SYS_USER_GROUP.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="UserGroupNo" HeaderText="UserGroupNo" SortExpression="UserGroupNo" ItemStyle-HorizontalAlign="Center"  /> 
