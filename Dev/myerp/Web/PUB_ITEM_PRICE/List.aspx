<%@ Page Title="PUB_ITEM_PRICE" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_ITEM_PRICE.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="STOP_DATE" HeaderText="STOP_DATE" SortExpression="STOP_DATE" ItemStyle-HorizontalAlign="Center"  /> 
