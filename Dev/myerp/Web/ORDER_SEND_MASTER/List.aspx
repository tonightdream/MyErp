<%@ Page Title="ORDER_SEND_MASTER" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.ORDER_SEND_MASTER.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="NOW_STATUS" HeaderText="NOW_STATUS" SortExpression="NOW_STATUS" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="NOW_DATE" HeaderText="NOW_DATE" SortExpression="NOW_DATE" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="SALE_NAME" HeaderText="SALE_NAME" SortExpression="SALE_NAME" ItemStyle-HorizontalAlign="Center"  /> 
