<%@ Page Title="PUB_CUSTOM_TYPE" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_CUSTOM_TYPE.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="CRDATE_NAME" HeaderText="CRDATE_NAME" SortExpression="CRDATE_NAME" ItemStyle-HorizontalAlign="Center"  /> 
