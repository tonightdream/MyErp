<%@ Page Title="PUB_CONSTANT" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_CONSTANT.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="CONST_TYPE" HeaderText="CONST_TYPE" SortExpression="CONST_TYPE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="CONST_CODE" HeaderText="CONST_CODE" SortExpression="CONST_CODE" ItemStyle-HorizontalAlign="Center"  /> 
