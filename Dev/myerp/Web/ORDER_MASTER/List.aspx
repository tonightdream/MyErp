<%@ Page Title="ORDER_MASTER" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.ORDER_MASTER.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="MASTERID,BILLNO" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="FACTORY" HeaderText="FACTORY" SortExpression="FACTORY" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BILL_TYPE" HeaderText="BILL_TYPE" SortExpression="BILL_TYPE" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="SCYQ" HeaderText="SCYQ" SortExpression="SCYQ" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="BZTYPE" HeaderText="BZTYPE" SortExpression="BZTYPE" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="REMARK1" HeaderText="REMARK1" SortExpression="REMARK1" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="REMARK2" HeaderText="REMARK2" SortExpression="REMARK2" ItemStyle-HorizontalAlign="Center"  /> 
                            
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="MASTERID,BILLNO" DataNavigateUrlFormatString="Show.aspx?id0={0}&id1={1}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="MASTERID,BILLNO" DataNavigateUrlFormatString="Modify.aspx?id0={0}&id1={1}"
                                Text="编辑"  />
