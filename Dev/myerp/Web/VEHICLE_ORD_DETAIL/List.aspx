<%@ Page Title="VEHICLE_ORD_DETAIL" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.VEHICLE_ORD_DETAIL.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="SALES_CONTRACTNO" HeaderText="SALES_CONTRACTNO" SortExpression="SALES_CONTRACTNO" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="TRUCKER" HeaderText="TRUCKER" SortExpression="TRUCKER" ItemStyle-HorizontalAlign="Center"  /> 
