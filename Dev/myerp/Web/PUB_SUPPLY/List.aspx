<%@ Page Title="PUB_SUPPLY" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_SUPPLY.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="PARENT_SUPPLY_CODE" HeaderText="PARENT_SUPPLY_CODE" SortExpression="PARENT_SUPPLY_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="TypeCode" HeaderText="TypeCode" SortExpression="TypeCode" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="TELPHONE1" HeaderText="TELPHONE1" SortExpression="TELPHONE1" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="EASYCODE" HeaderText="EASYCODE" SortExpression="EASYCODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Contact_MAN" HeaderText="Contact_MAN" SortExpression="Contact_MAN" ItemStyle-HorizontalAlign="Center"  /> 
