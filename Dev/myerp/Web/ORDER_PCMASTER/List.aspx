<%@ Page Title="ORDER_PCMASTER" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.ORDER_PCMASTER.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="GROUP" HeaderText="GROUP" SortExpression="GROUP" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="MACHINE" HeaderText="MACHINE" SortExpression="MACHINE" ItemStyle-HorizontalAlign="Center"  /> 
