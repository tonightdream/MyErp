<%@ Page Title="ORDER_ZBWGDETAIL" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.ORDER_ZBWGDETAIL.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ZXBJNAME" HeaderText="ZXBJNAME" SortExpression="ZXBJNAME" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Quantity" HeaderText="Quantity" SortExpression="Quantity" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="FPqty" HeaderText="FPqty" SortExpression="FPqty" ItemStyle-HorizontalAlign="Center"  /> 
