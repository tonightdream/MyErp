<%@ Page Title="PUB_PRICE" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_PRICE.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ALL_PRICE" HeaderText="ALL_PRICE" SortExpression="ALL_PRICE" ItemStyle-HorizontalAlign="Center"  /> 
