<%@ Page Title="PUB_FIXEDASSET" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_FIXEDASSET.List" %>
...
<!--Title -->
            ...
            <asp:GridView ID="gridView" runat="server" AllowPaging="True" Width="100%" CellPadding="3"  OnPageIndexChanging ="gridView_PageIndexChanging"
                    BorderWidth="1px" DataKeyNames="ITEM_INTERNAL_CODE" OnRowDataBound="gridView_RowDataBound"
		...
		<asp:BoundField DataField="FIXEDASSET_CODE" HeaderText="FIXEDASSET_CODE" SortExpression="FIXEDASSET_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="FIXEDASSET_NAME" HeaderText="FIXEDASSET_NAME" SortExpression="FIXEDASSET_NAME" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="SUPPLY_CODE" HeaderText="SUPPLY_CODE" SortExpression="SUPPLY_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="SUPPLY_NAME" HeaderText="SUPPLY_NAME" SortExpression="SUPPLY_NAME" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="OUT_DATE" HeaderText="OUT_DATE" SortExpression="OUT_DATE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="POWER_RATE" HeaderText="POWER_RATE" SortExpression="POWER_RATE" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="FIXEDASSET_STATUS" HeaderText="FIXEDASSET_STATUS" SortExpression="FIXEDASSET_STATUS" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="REMARK" HeaderText="REMARK" SortExpression="REMARK" ItemStyle-HorizontalAlign="Center"  /> 
                            ...
                            <asp:HyperLinkField HeaderText="详细" ControlStyle-Width="50" DataNavigateUrlFields="ITEM_INTERNAL_CODE" DataNavigateUrlFormatString="Show.aspx?id={0}"
                                Text="详细"  />
                            <asp:HyperLinkField HeaderText="编辑" ControlStyle-Width="50" DataNavigateUrlFields="ITEM_INTERNAL_CODE" DataNavigateUrlFormatString="Modify.aspx?id={0}"
                                Text="编辑"  />
