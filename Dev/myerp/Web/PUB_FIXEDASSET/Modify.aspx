<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="MyERP.Web.PUB_FIXEDASSET.Modify" Title="修改页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtFIXEDASSET_CODE" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		FIXEDASSET_NAME
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtFIXEDASSET_NAME" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		SPECIFICATIONS
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox ID="txtOUT_DATE" runat="server" Width="70px"  onfocus="setday(this)"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		POWER_RATE
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtPOWER_RATE" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BEGIN_DATE
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:TextBox id="txtFIXEDASSET_STATUS" runat="server" Width="200px"></asp:TextBox>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		DEPARTMENT_CODE
