<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="MyERP.Web.PUB_FIXEDASSET.Show" Title="显示页" %>
...
<table cellSpacing="0" cellPadding="0" width="100%" border="0">
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblFIXEDASSET_CODE" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		FIXEDASSET_NAME
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblFIXEDASSET_NAME" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		SPECIFICATIONS
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblOUT_DATE" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		POWER_RATE
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblPOWER_RATE" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		BEGIN_DATE
	...
	：</td>
	<td height="25" width="*" align="left">
		<asp:Label id="lblFIXEDASSET_STATUS" runat="server"></asp:Label>
	</td></tr>
	<tr>
	<td height="25" width="30%" align="right">
		DEPARTMENT_CODE
