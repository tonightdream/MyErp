<%@ Page Title="PUB_ITEM_DA" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_ITEM_DA.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ITEM_NO" HeaderText="ITEM_NO" SortExpression="ITEM_NO" ItemStyle-HorizontalAlign="Center"  /> 
