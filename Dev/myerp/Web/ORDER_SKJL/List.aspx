<%@ Page Title="ORDER_SKJL" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.ORDER_SKJL.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="JZBH" HeaderText="JZBH" SortExpression="JZBH" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="SKJE" HeaderText="SKJE" SortExpression="SKJE" ItemStyle-HorizontalAlign="Center"  /> 
