<%@ Page Title="PUB_CURRENCY" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_CURRENCY.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="CURRENCY_CODE" HeaderText="CURRENCY_CODE" SortExpression="CURRENCY_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="CURRENCY_NAME" HeaderText="CURRENCY_NAME" SortExpression="CURRENCY_NAME" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="EXCHANGE_RATE" HeaderText="EXCHANGE_RATE" SortExpression="EXCHANGE_RATE" ItemStyle-HorizontalAlign="Center"  /> 
