<%@ Page Title="PUB_BAR_CODE" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_BAR_CODE.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="BAR_CODE" HeaderText="BAR_CODE" SortExpression="BAR_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="COLOR_CODE" HeaderText="COLOR_CODE" SortExpression="COLOR_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="RULER_CODE" HeaderText="RULER_CODE" SortExpression="RULER_CODE" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="LENGTH_CODE" HeaderText="LENGTH_CODE" SortExpression="LENGTH_CODE" ItemStyle-HorizontalAlign="Center"  /> 
