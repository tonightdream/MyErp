<%@ Page Title="PUB_COMPANY_TYPE" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.PUB_COMPANY_TYPE.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="COMPANY_TYPE" HeaderText="COMPANY_TYPE" SortExpression="COMPANY_TYPE" ItemStyle-HorizontalAlign="Center"  /> 
