<%@ Page Title="ORDER_ZBPrice" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.ORDER_ZBPrice.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="ZBGGID" HeaderText="ZBGGID" SortExpression="ZBGGID" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ZBBH" HeaderText="ZBBH" SortExpression="ZBBH" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="PZMC" HeaderText="PZMC" SortExpression="PZMC" ItemStyle-HorizontalAlign="Center"  /> 
