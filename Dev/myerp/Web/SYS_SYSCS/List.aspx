<%@ Page Title="SYS_SYSCS" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="MyERP.Web.SYS_SYSCS.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="SHDCNT" HeaderText="SHDCNT" SortExpression="SHDCNT" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ITEM_CODE_LENGTH" HeaderText="ITEM_CODE_LENGTH" SortExpression="ITEM_CODE_LENGTH" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="Billasstock" HeaderText="Billasstock" SortExpression="Billasstock" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="MAYLH" HeaderText="MAYLH" SortExpression="MAYLH" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="ServiceTelphone" HeaderText="ServiceTelphone" SortExpression="ServiceTelphone" ItemStyle-HorizontalAlign="Center"  /> 
