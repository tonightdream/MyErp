...
{
	/// <summary>
	/// 数据访问类:ORDER_TCDETAIL
	/// </summary>
	public partial class ORDER_TCDETAIL
	{
		public ORDER_TCDETAIL()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MyERP.Model.ORDER_TCDETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ORDER_TCDETAIL(");
			strSql.Append("DetailID,BillNO,Sequence,ItemInternalCode,ZXBJNO,ZXBJNAME,Quantity,CREATE_DATE,CREATE_NAME,REMARK)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyERP.Model.ORDER_TCDETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ORDER_TCDETAIL set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ORDER_TCDETAIL ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.ORDER_TCDETAIL GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 DetailID,BillNO,Sequence,ItemInternalCode,ZXBJNO,ZXBJNAME,Quantity,CREATE_DATE,CREATE_NAME,REMARK from ORDER_TCDETAIL ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.ORDER_TCDETAIL DataRowToModel(DataRow row)
		{
			MyERP.Model.ORDER_TCDETAIL model=new MyERP.Model.ORDER_TCDETAIL();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select DetailID,BillNO,Sequence,ItemInternalCode,ZXBJNO,ZXBJNAME,Quantity,CREATE_DATE,CREATE_NAME,REMARK ");
			strSql.Append(" FROM ORDER_TCDETAIL ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM ORDER_TCDETAIL ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ORDER_TCDETAIL T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ORDER_TCDETAIL";
