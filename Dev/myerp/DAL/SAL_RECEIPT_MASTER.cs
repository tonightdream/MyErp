...
namespace MyERP.DAL
{
	...
	public partial class SAL_RECEIPT_MASTER
	{
		...
		public bool Exists(string BillNO)
		{
			...
			strSql.Append("select count(1) from SAL_RECEIPT_MASTER");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SAL_RECEIPT_MASTER(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SAL_RECEIPT_MASTER set ");
		...
		public bool Delete(string BillNO)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SAL_RECEIPT_MASTER ");
			strSql.Append(" where BillNO=@BillNO ");
			SqlParameter[] parameters = {
					new SqlParameter("@BillNO", SqlDbType.NVarChar,50)			};
			parameters[0].Value = BillNO;
		...
		public MyERP.Model.SAL_RECEIPT_MASTER GetModel(string BillNO)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 BillNO,COMPANY_CODE,COMPANY_NAME,PARENT_COMPANY_CODE,CUSTOM_CODE,CUSTOM_NAME,BillTYPE,STOCK_CODE,STOCK_NAME,INSTOCK_CODE,INSTOCK_NAME,EMPLOYEE_CODE,EMPLOYEE_NAME,BillDate,BILL_STATUS,PayAcount,REMARK from SAL_RECEIPT_MASTER ");
			strSql.Append(" where BillNO=@BillNO ");
			SqlParameter[] parameters = {
					new SqlParameter("@BillNO", SqlDbType.NVarChar,50)			};
			parameters[0].Value = BillNO;
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.SAL_RECEIPT_MASTER DataRowToModel(DataRow row)
		{
			MyERP.Model.SAL_RECEIPT_MASTER model=new MyERP.Model.SAL_RECEIPT_MASTER();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM SAL_RECEIPT_MASTER ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SAL_RECEIPT_MASTER T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SAL_RECEIPT_MASTER";
