...
namespace MyERP.DAL
{
	...
	public partial class SAL_RECEIPT_DETAIL
	{
		...
		public int Add(MyERP.Model.SAL_RECEIPT_DETAIL model)
		{
			...
			strSql.Append("insert into SAL_RECEIPT_DETAIL(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SAL_RECEIPT_DETAIL set ");
		...
		public bool Delete(int TempID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SAL_RECEIPT_DETAIL ");
			strSql.Append(" where TempID=@TempID");
			SqlParameter[] parameters = {
					new SqlParameter("@TempID", SqlDbType.Int,4)
			};
		...
		public MyERP.Model.SAL_RECEIPT_DETAIL GetModel(int TempID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TempID,BillNo,SEQUENCE,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,PARENT_ITEM_CODE,ITEM_TYPE,ITEM_COLOR,SPECIFICATIONS,MEASURE_UNIT,NET_PRICE,PRICE,ACTUAL_QTY,QUANTITY,YKQUANTITY,PAYAMOUNT,NET_PAYAMOUNT,BARCODE,REMARK from SAL_RECEIPT_DETAIL ");
			strSql.Append(" where TempID=@TempID");
			SqlParameter[] parameters = {
					new SqlParameter("@TempID", SqlDbType.Int,4)
			};
			...
			MyERP.Model.SAL_RECEIPT_DETAIL model=new MyERP.Model.SAL_RECEIPT_DETAIL();
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.SAL_RECEIPT_DETAIL DataRowToModel(DataRow row)
		{
			MyERP.Model.SAL_RECEIPT_DETAIL model=new MyERP.Model.SAL_RECEIPT_DETAIL();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM SAL_RECEIPT_DETAIL ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM SAL_RECEIPT_DETAIL ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from SAL_RECEIPT_DETAIL T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "SAL_RECEIPT_DETAIL";
