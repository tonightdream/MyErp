...
{
	/// <summary>
	/// 数据访问类:ORDER_THDETAIL
	/// </summary>
	public partial class ORDER_THDETAIL
	{
		public ORDER_THDETAIL()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MyERP.Model.ORDER_THDETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ORDER_THDETAIL(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyERP.Model.ORDER_THDETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ORDER_THDETAIL set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ORDER_THDETAIL ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.ORDER_THDETAIL GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 DetailID,BillNo,Sequence,ItemInternalCode,ZXBJNO,SHDH,Quantity,THRQ,CREATE_NAME,CREATE_DATE,REMARK from ORDER_THDETAIL ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.ORDER_THDETAIL DataRowToModel(DataRow row)
		{
			MyERP.Model.ORDER_THDETAIL model=new MyERP.Model.ORDER_THDETAIL();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM ORDER_THDETAIL ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM ORDER_THDETAIL ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ORDER_THDETAIL T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ORDER_THDETAIL";
