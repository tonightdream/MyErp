...
namespace MyERP.DAL
{
	...
	public partial class ORDER_MASTER
	{
		...
		public bool Exists(string MASTERID,string BILLNO)
		{
			...
			strSql.Append("select count(1) from ORDER_MASTER");
			strSql.Append(" where MASTERID=@MASTERID and BILLNO=@BILLNO ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ORDER_MASTER(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ORDER_MASTER set ");
			...
			parameters[4].Value = model.BILL_TYPE;
			parameters[5].Value = model.BILL_DATE;
			parameters[6].Value = model.BILL_STATUS;
			parameters[7].Value = model.SCYQ;
			parameters[8].Value = model.BZTYPE;
			parameters[9].Value = model.STOCK_CODE;
			parameters[10].Value = model.STOCK_NAME;
			parameters[11].Value = model.DEPARTMENT_CODE;
			parameters[12].Value = model.DEPARTMENT_NAME;
			parameters[13].Value = model.CREATE_CODE;
			...
			parameters[19].Value = model.MASTERID;
		...
		public bool Delete(string MASTERID,string BILLNO)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ORDER_MASTER ");
			strSql.Append(" where MASTERID=@MASTERID and BILLNO=@BILLNO ");
			SqlParameter[] parameters = {
					new SqlParameter("@MASTERID", SqlDbType.VarChar,50),
					new SqlParameter("@BILLNO", SqlDbType.VarChar,50)			};
		...
		public MyERP.Model.ORDER_MASTER GetModel(string MASTERID,string BILLNO)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 MASTERID,BILLNO,MANUAL_BILLNO,CUSTOM_CODE,CUSTOM_NAME,FACTORY,BILL_TYPE,BILL_DATE,BILL_STATUS,SCYQ,BZTYPE,STOCK_CODE,STOCK_NAME,DEPARTMENT_CODE,DEPARTMENT_NAME,CREATE_CODE,CREATE_NAME,CREATE_DATE,REMARK,REMARK1,REMARK2 from ORDER_MASTER ");
			strSql.Append(" where MASTERID=@MASTERID and BILLNO=@BILLNO ");
			SqlParameter[] parameters = {
					new SqlParameter("@MASTERID", SqlDbType.VarChar,50),
					new SqlParameter("@BILLNO", SqlDbType.VarChar,50)			};
			...
			MyERP.Model.ORDER_MASTER model=new MyERP.Model.ORDER_MASTER();
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.ORDER_MASTER DataRowToModel(DataRow row)
		{
			MyERP.Model.ORDER_MASTER model=new MyERP.Model.ORDER_MASTER();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select MASTERID,BILLNO,MANUAL_BILLNO,CUSTOM_CODE,CUSTOM_NAME,FACTORY,BILL_TYPE,BILL_DATE,BILL_STATUS,SCYQ,BZTYPE,STOCK_CODE,STOCK_NAME,DEPARTMENT_CODE,DEPARTMENT_NAME,CREATE_CODE,CREATE_NAME,CREATE_DATE,REMARK,REMARK1,REMARK2 ");
			strSql.Append(" FROM ORDER_MASTER ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ORDER_MASTER T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ORDER_MASTER";
			parameters[1].Value = "BILLNO";
