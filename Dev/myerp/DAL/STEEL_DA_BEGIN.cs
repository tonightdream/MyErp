...
namespace MyERP.DAL
{
	...
	public partial class STEEL_DA_BEGIN
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MyERP.Model.STEEL_DA_BEGIN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into STEEL_DA_BEGIN(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyERP.Model.STEEL_DA_BEGIN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update STEEL_DA_BEGIN set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from STEEL_DA_BEGIN ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.STEEL_DA_BEGIN GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 COMPANY_CODE,COMPANY_NAME,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,PARENT_ITEM_CODE,ACTUAL_QTY,CREATE_DATE from STEEL_DA_BEGIN ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.STEEL_DA_BEGIN DataRowToModel(DataRow row)
		{
			MyERP.Model.STEEL_DA_BEGIN model=new MyERP.Model.STEEL_DA_BEGIN();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM STEEL_DA_BEGIN ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM STEEL_DA_BEGIN ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from STEEL_DA_BEGIN T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "STEEL_DA_BEGIN";
