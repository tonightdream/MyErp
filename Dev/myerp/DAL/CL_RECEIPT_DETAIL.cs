...
{
	/// <summary>
	/// 数据访问类:CL_RECEIPT_DETAIL
	/// </summary>
	public partial class CL_RECEIPT_DETAIL
	{
		public CL_RECEIPT_DETAIL()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public int Add(MyERP.Model.CL_RECEIPT_DETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into CL_RECEIPT_DETAIL(");
			strSql.Append("BillNo,SEQUENCE,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,PARENT_ITEM_CODE,SPECIFICATIONS,MEASURE_UNIT,ITEM_TYPE,ITEM_COLOR,NET_PRICE,PRICE,ITEM_JZ,QTY,QUANTITY,ACTUAL_QTY,YKQUANTITY,PAYAMOUNT,SUPPLY_CODE,SUPPLY_NAME,POSITION,BARCODE,REMARK,DESCRIPTION)");
			...
			parameters[15].Value = model.ACTUAL_QTY;
			parameters[16].Value = model.YKQUANTITY;
			parameters[17].Value = model.PAYAMOUNT;
			parameters[18].Value = model.SUPPLY_CODE;
			parameters[19].Value = model.SUPPLY_NAME;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyERP.Model.CL_RECEIPT_DETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CL_RECEIPT_DETAIL set ");
			...
			parameters[22].Value = model.REMARK;
			parameters[23].Value = model.DESCRIPTION;
			parameters[24].Value = model.TempID;
		...
		public bool Delete(int TempID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CL_RECEIPT_DETAIL ");
			strSql.Append(" where TempID=@TempID");
			SqlParameter[] parameters = {
					new SqlParameter("@TempID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.CL_RECEIPT_DETAIL GetModel(int TempID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 TempID,BillNo,SEQUENCE,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,PARENT_ITEM_CODE,SPECIFICATIONS,MEASURE_UNIT,ITEM_TYPE,ITEM_COLOR,NET_PRICE,PRICE,ITEM_JZ,QTY,QUANTITY,ACTUAL_QTY,YKQUANTITY,PAYAMOUNT,SUPPLY_CODE,SUPPLY_NAME,POSITION,BARCODE,REMARK,DESCRIPTION from CL_RECEIPT_DETAIL ");
			strSql.Append(" where TempID=@TempID");
			SqlParameter[] parameters = {
					new SqlParameter("@TempID", SqlDbType.Int,4)
			};
			...
			MyERP.Model.CL_RECEIPT_DETAIL model=new MyERP.Model.CL_RECEIPT_DETAIL();
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.CL_RECEIPT_DETAIL DataRowToModel(DataRow row)
		{
			MyERP.Model.CL_RECEIPT_DETAIL model=new MyERP.Model.CL_RECEIPT_DETAIL();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select TempID,BillNo,SEQUENCE,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,PARENT_ITEM_CODE,SPECIFICATIONS,MEASURE_UNIT,ITEM_TYPE,ITEM_COLOR,NET_PRICE,PRICE,ITEM_JZ,QTY,QUANTITY,ACTUAL_QTY,YKQUANTITY,PAYAMOUNT,SUPPLY_CODE,SUPPLY_NAME,POSITION,BARCODE,REMARK,DESCRIPTION ");
			strSql.Append(" FROM CL_RECEIPT_DETAIL ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" TempID,BillNo,SEQUENCE,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,PARENT_ITEM_CODE,SPECIFICATIONS,MEASURE_UNIT,ITEM_TYPE,ITEM_COLOR,NET_PRICE,PRICE,ITEM_JZ,QTY,QUANTITY,ACTUAL_QTY,YKQUANTITY,PAYAMOUNT,SUPPLY_CODE,SUPPLY_NAME,POSITION,BARCODE,REMARK,DESCRIPTION ");
			strSql.Append(" FROM CL_RECEIPT_DETAIL ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM CL_RECEIPT_DETAIL ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CL_RECEIPT_DETAIL T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "CL_RECEIPT_DETAIL";
