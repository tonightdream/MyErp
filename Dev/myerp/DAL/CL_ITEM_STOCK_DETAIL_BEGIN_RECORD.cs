...
{
	/// <summary>
	/// 数据访问类:CL_ITEM_STOCK_DETAIL_BEGIN_RECORD
	/// </summary>
	public partial class CL_ITEM_STOCK_DETAIL_BEGIN_RECORD
	{
		...
		public bool Add(MyERP.Model.CL_ITEM_STOCK_DETAIL_BEGIN_RECORD model)
		{
			...
			strSql.Append("insert into CL_ITEM_STOCK_DETAIL_BEGIN_RECORD(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update CL_ITEM_STOCK_DETAIL_BEGIN_RECORD set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from CL_ITEM_STOCK_DETAIL_BEGIN_RECORD ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		public MyERP.Model.CL_ITEM_STOCK_DETAIL_BEGIN_RECORD GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 COMPANY_CODE,COMPANY_NAME,CREATE_DATE,CREATE_NAME from CL_ITEM_STOCK_DETAIL_BEGIN_RECORD ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.CL_ITEM_STOCK_DETAIL_BEGIN_RECORD DataRowToModel(DataRow row)
		{
			MyERP.Model.CL_ITEM_STOCK_DETAIL_BEGIN_RECORD model=new MyERP.Model.CL_ITEM_STOCK_DETAIL_BEGIN_RECORD();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM CL_ITEM_STOCK_DETAIL_BEGIN_RECORD ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM CL_ITEM_STOCK_DETAIL_BEGIN_RECORD ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from CL_ITEM_STOCK_DETAIL_BEGIN_RECORD T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "CL_ITEM_STOCK_DETAIL_BEGIN_RECORD";
