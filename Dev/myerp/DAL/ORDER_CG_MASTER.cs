...
namespace MyERP.DAL
{
	...
	public partial class ORDER_CG_MASTER
	{
		...
		public bool Exists(string BILLNO)
		{
			...
			strSql.Append("select count(1) from ORDER_CG_MASTER");
		...
		public bool Delete(string BILLNO)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ORDER_CG_MASTER ");
			strSql.Append(" where BILLNO=@BILLNO ");
			SqlParameter[] parameters = {
					new SqlParameter("@BILLNO", SqlDbType.VarChar,50)			};
			parameters[0].Value = BILLNO;
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM ORDER_CG_MASTER ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ORDER_CG_MASTER T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ORDER_CG_MASTER";
