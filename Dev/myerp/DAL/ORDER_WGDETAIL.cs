...
{
	/// <summary>
	/// 数据访问类:ORDER_WGDETAIL
	/// </summary>
	public partial class ORDER_WGDETAIL
	{
		public ORDER_WGDETAIL()
		{}
		#region  BasicMethod
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MyERP.Model.ORDER_WGDETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into ORDER_WGDETAIL(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyERP.Model.ORDER_WGDETAIL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update ORDER_WGDETAIL set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from ORDER_WGDETAIL ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.ORDER_WGDETAIL GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 DetailID,BillNO,Sequence,ItemInternalCode,ZXBJNO,ZXBJNAME,Quantity,FPqty,CREATE_DATE,CREATE_NAME,REMARK from ORDER_WGDETAIL ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			MyERP.Model.ORDER_WGDETAIL model=new MyERP.Model.ORDER_WGDETAIL();
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.ORDER_WGDETAIL DataRowToModel(DataRow row)
		{
			MyERP.Model.ORDER_WGDETAIL model=new MyERP.Model.ORDER_WGDETAIL();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM ORDER_WGDETAIL ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM ORDER_WGDETAIL ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from ORDER_WGDETAIL T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "ORDER_WGDETAIL";
