...
namespace MyERP.DAL
{
	...
	public partial class WL_STOCK_BEGIN
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MyERP.Model.WL_STOCK_BEGIN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into WL_STOCK_BEGIN(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyERP.Model.WL_STOCK_BEGIN model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update WL_STOCK_BEGIN set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from WL_STOCK_BEGIN ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.WL_STOCK_BEGIN GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 STOCK_CODE,STOCK_NAME,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,ACTUAL_QTY,CREATE_DATE from WL_STOCK_BEGIN ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.WL_STOCK_BEGIN DataRowToModel(DataRow row)
		{
			MyERP.Model.WL_STOCK_BEGIN model=new MyERP.Model.WL_STOCK_BEGIN();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select STOCK_CODE,STOCK_NAME,ITEM_INTERNAL_CODE,ITEM_CODE,ITEM_NAME,ACTUAL_QTY,CREATE_DATE ");
			strSql.Append(" FROM WL_STOCK_BEGIN ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM WL_STOCK_BEGIN ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from WL_STOCK_BEGIN T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "WL_STOCK_BEGIN";
