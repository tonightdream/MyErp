...
namespace MyERP.DAL
{
	...
	public partial class VEHICLE_ORD_MASTER
	{
		...
		public bool Exists(string BillNo)
		{
			...
			strSql.Append("select count(1) from VEHICLE_ORD_MASTER");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MyERP.Model.VEHICLE_ORD_MASTER model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VEHICLE_ORD_MASTER(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyERP.Model.VEHICLE_ORD_MASTER model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VEHICLE_ORD_MASTER set ");
		...
		public bool Delete(string BillNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VEHICLE_ORD_MASTER ");
			strSql.Append(" where BillNo=@BillNo ");
			SqlParameter[] parameters = {
					new SqlParameter("@BillNo", SqlDbType.NVarChar,50)			};
			parameters[0].Value = BillNo;
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.VEHICLE_ORD_MASTER GetModel(string BillNo)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 BillNo,MANUAL_BILLNO,COMPANY_CODE,COMPANY_NAME,CUSTOM_CODE,CUSTOM_NAME,BILLTYPE,BILL_STATUS,STOCK_CODE,STOCK_NAME,DEPARTMENT_CODE,DEPARTMENT_NAME,EMPLOYEE_CODE,EMPLOYEE_NAME,BILLDATE,CREATE_DATE,REMARK from VEHICLE_ORD_MASTER ");
			strSql.Append(" where BillNo=@BillNo ");
			SqlParameter[] parameters = {
					new SqlParameter("@BillNo", SqlDbType.NVarChar,50)			};
			parameters[0].Value = BillNo;

			MyERP.Model.VEHICLE_ORD_MASTER model=new MyERP.Model.VEHICLE_ORD_MASTER();
		...
		/// 得到一个对象实体
		/// </summary>
		public MyERP.Model.VEHICLE_ORD_MASTER DataRowToModel(DataRow row)
		{
			MyERP.Model.VEHICLE_ORD_MASTER model=new MyERP.Model.VEHICLE_ORD_MASTER();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM VEHICLE_ORD_MASTER ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VEHICLE_ORD_MASTER T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VEHICLE_ORD_MASTER";
