...
namespace MyERP.BLL
{
	...
	{
		private readonly MyERP.DAL.STEEL_DA dal=new MyERP.DAL.STEEL_DA();
		public STEEL_DA()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyERP.Model.STEEL_DA GetModelByCache(string ITEM_CODE)
		{
			
			string CacheKey = "STEEL_DAModel-" + ITEM_CODE;
			...
			return (MyERP.Model.STEEL_DA)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyERP.Model.STEEL_DA> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyERP.Model.STEEL_DA> DataTableToList(DataTable dt)
		{
			List<MyERP.Model.STEEL_DA> modelList = new List<MyERP.Model.STEEL_DA>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyERP.Model.STEEL_DA model;
