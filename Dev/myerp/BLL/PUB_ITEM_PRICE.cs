...
namespace MyERP.BLL
{
	...
	{
		private readonly MyERP.DAL.PUB_ITEM_PRICE dal=new MyERP.DAL.PUB_ITEM_PRICE();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyERP.Model.PUB_ITEM_PRICE GetModelByCache(string ITEM_CODE)
		{
			
			string CacheKey = "PUB_ITEM_PRICEModel-" + ITEM_CODE;
			...
			return (MyERP.Model.PUB_ITEM_PRICE)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyERP.Model.PUB_ITEM_PRICE> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyERP.Model.PUB_ITEM_PRICE> DataTableToList(DataTable dt)
		{
			List<MyERP.Model.PUB_ITEM_PRICE> modelList = new List<MyERP.Model.PUB_ITEM_PRICE>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyERP.Model.PUB_ITEM_PRICE model;
