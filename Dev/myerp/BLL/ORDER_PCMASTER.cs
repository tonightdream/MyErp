...
namespace MyERP.BLL
{
	...
	{
		private readonly MyERP.DAL.ORDER_PCMASTER dal=new MyERP.DAL.ORDER_PCMASTER();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyERP.Model.ORDER_PCMASTER GetModelByCache(string BillNo)
		{
			
			string CacheKey = "ORDER_PCMASTERModel-" + BillNo;
			...
			return (MyERP.Model.ORDER_PCMASTER)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyERP.Model.ORDER_PCMASTER> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyERP.Model.ORDER_PCMASTER> DataTableToList(DataTable dt)
		{
			List<MyERP.Model.ORDER_PCMASTER> modelList = new List<MyERP.Model.ORDER_PCMASTER>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyERP.Model.ORDER_PCMASTER model;
