...
{
	/// <summary>
	/// VEHICLE_ORD_DETAIL:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class VEHICLE_ORD_DETAIL
	{
		...
		private string _sales_contractno;
		...
		/// 
		/// </summary>
		public string SALES_CONTRACTNO
		{
			set{ _sales_contractno=value;}
			get{return _sales_contractno;}
		}
		/// <summary>
		/// 
		/// </summary>
